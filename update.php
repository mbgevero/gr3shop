...
if(isset($_POST['update_product'])){
    ...
    if($update_products){
        ...
        $display_message= "Updating Product Failed";
    }
...
<body>
    ...
    if(isset($display_message)){
        ...
        <i class='fas fa-times' onclick='this.parentElement.style.
        display=`none`';></i>
    </div>";
    }
    ...
    ?>
         <section class="edit_container">
            ...
            class="update_product product_container_box"> 
                ...
                <input type="text" class="input_fields fields"required value="<?php echo
                $fetch_data['name']?>" name="update_product_name">
                <input type="number" class="input_fields fields"required value="<?php echo 
                $fetch_data['price']?>"name="update_product_price">
